...
@section('styles')
    ...
    <style>
        .form-booking {
            background-image: url(https://www.megapowerpro.com/storage/bookingForm.jpg) !important;
...
@section('header')
    <div class="header sub-page">
        <div class="nav-bar">
            ...
            <nav>
                <ul class="navbar">
                    ...
                    <li><a href="{{ route('booking') }}" class="nav__link active">{{ trans('front/index.الحجز') }}</a>
                    </li>
        ...
        <img class="image-sub-page" src="{{ Storage::url('booking.jpeg') }}">
        <h1 class="title-page">{{ trans('front/index.الحجز') }}</h1>
    </div>
@endsection

@section('content')
    <div class="booking booking-page">
        <div class="container">
            <div class="form-booking">
                <ul class="tabs-booking">
                    <li class="active" data-cont=".two">{{ trans('dashboard/master.purchase') }}</li>
                    <li  data-cont=".one">{{ trans('front/index.الحجز') }}</li>
                </ul>
                <div class="tab-content-booking">
                    <div class="two">
                        <livewire:front.contact.buys-create>
                    </div>
                    <div class="one">
                        <livewire:front.contact.reservations-create>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    <script src="{{ asset('front/assets/js/tabs_booking.js') }}"></script>
@endsection
